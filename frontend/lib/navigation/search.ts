...
const ROUTE_CATALOG: Array<{
  ...
  { title: 'Schedule', href: '/worker/my-schedule', portal: 'worker', description: 'Submit available days and hours.', keywords: ['schedule', 'shifts', 'calendar', 'availability'] },
  { title: 'My absences', href: '/worker/absences', portal: 'worker', description: 'Upcoming shifts and absence reports.', keywords: ['absence', 'sick', 'cant attend', 'shifts'] },
