import {
  ...
  Briefcase, Wallet, Coins, GraduationCap, FileBarChart,
} from 'lucide-react';
...
export const PORTAL_SIDEBAR_NAV: Record<PortalRole, NavItem[]> = {
  worker: [
    ...
    { icon: <Wallet size={18} />, label: 'My Wallet', href: '/worker/wallet', shortLabel: 'Wallet' },
  ...
  admin: [
    ...
    { icon: <GraduationCap size={18} />, label: 'Training', href: '/admin/training' },
    { icon: <DollarSign size={18} />, label: 'Payroll', href: '/admin/payroll' },
    { icon: <Wallet size={18} />, label: 'Wallets', href: '/admin/wallets' },
    { icon: <Coins size={18} />, label: 'Currencies', href: '/admin/currencies' },
    { icon: <Send size={18} />, label: 'Communications', href: '/admin/payroll/receipts', shortLabel: 'Comms' },
    { icon: <FileBarChart size={18} />, label: 'Reports', href: '/admin/reports' },
