import {
  ...
  Bell, DollarSign, BarChart3, Activity, BookOpen,
...
export const PORTAL_SIDEBAR_NAV: Record<PortalRole, NavItem[]> = {
  ...
  admin: [
    ...
    { icon: <Users size={18} />, label: 'People', href: '/admin/workers', shortLabel: 'People' },
    { icon: <Monitor size={18} />, label: 'Operations', href: '/admin/rdp', shortLabel: 'Ops' },
