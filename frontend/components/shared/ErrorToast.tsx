...
export default function ErrorToast({ message, onDismiss, retryLabel = 'Refresh' }: ErrorToastProps) {
    ...
    <div role="alert" aria-live="assertive" className="fixed inset-x-4 bottom-4 z-[100] mx-auto w-auto max-w-md rounded-2xl border border-red-400/35 bg-[#10251f]/95 p-4 text-white shadow-2xl backdrop-blur-xl sm:left-auto sm:right-6 sm:w-[26rem]">
      <div className="flex gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold">We need your attention</p>
          ...
          <div className="mt-3 flex items-center gap-3 text-xs font-semibold">
            ...
            <Link href="/" className="inline-flex items-center gap-1 text-[#d4af37] hover:underline">
              <Home size={13} /> Home
            </Link>
          </div>
        </div>
