      ...
      <AuthGlassCard wide>
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <h1 className="text-xl sm:text-2xl font-display font-bold mt-5 tracking-tight text-white">
            {stage === 'sent' ? 'Message sent' : 'Contact us'}
          </h1>
          <p className="text-xs text-[#98b7af] text-center mt-3">
            {stage === 'sent'
              ? 'An administrator has been notified and will reply to your email.'
              : 'Locked out or need help? Send us a message — you do not need an account.'}
          </p>
        </div>
        ...
        {stage === 'sent' ? (
          ...
          <form onSubmit={submit} className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-4">
            <div>
            ...
            <div className="md:col-span-2">
              ...
              <select
                ...
                className="w-full bg-[#04201a]/80 text-white text-sm rounded-xl px-4 py-3 border border-[#0df5c4]/25 focus:border-[#0df5c4] focus:ring-1 focus:ring-[#0df5c4] outline-none transition-all"
              >
                {SUBJECTS.map((s) => (
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className={`${inputClass} resize-y min-h-[120px] pt-3`}
                />
              </div>
            ...
            <button
              ...
              className="md:col-span-2 w-full mt-2 flex items-center justify-center gap-2 py-3.5 px-6 rounded-xl font-bold text-sm text-[#01241c] bg-[#0df5c4] hover:bg-[#34f8cf] active:scale-[0.99] transition-all disabled:opacity-60"
            >
              {stage === 'sending' ? (
                <>
            ...
            <Link
              href="/login"
              className="md:col-span-2 mt-2 flex items-center justify-center gap-1.5 text-xs font-semibold text-[#98b7af] hover:text-[#0df5c4] transition-colors"
            >
