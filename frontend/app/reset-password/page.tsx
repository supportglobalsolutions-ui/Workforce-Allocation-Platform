...
export default function ResetPasswordPage() {
  ...
  async function updatePassword(event: FormEvent<HTMLFormElement>) {
    ...
    if (passwordBroken.length) {
      setError(passwordBroken[0]);
      return;
    }
      ...
      <AuthGlassCard>
        ...
        {stage === 'update' && (
          <form onSubmit={updatePassword} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={password}
                  onChange={(event) => setPassword(event.target.value.slice(0, PASSWORD_MAX))}
              ...
              {password.length > 0 && passwordRuleErrors(password).length > 0 && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(event) => setConfirmPassword(event.target.value.slice(0, PASSWORD_MAX))}
            ...
            <button type="submit" disabled={loading || (password.length > 0 && passwordRuleErrors(password).length > 0)} className="w-full mt-2 flex items-center justify-center gap-2 py-3.5 px-6 rounded-xl font-bold text-sm text-[#01241c] bg-[#0df5c4] hover:bg-[#34f8cf] active:scale-[0.99] transition-all disabled:opacity-60">
