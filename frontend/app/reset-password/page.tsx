      ...
      <AuthGlassCard>
        ...
        {submitted ? (
          <div className="text-center py-4">
            ...
            <p className="text-sm text-[#ddf5ee]">Recovery link sent. Check your inbox.</p>
          </div>
        ) : (
          <form
            onSubmit={(e) => {
          ...
          >
            ...
            <button
              type="submit"
              className="w-full mt-2 flex items-center justify-center gap-2 py-3.5 px-6 rounded-xl font-bold text-sm text-[#01241c] bg-[#0df5c4] hover:bg-[#34f8cf] active:scale-[0.99] transition-all shadow-[0_0_28px_rgba(13,245,196,0.4)]"
            >
